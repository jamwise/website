/* @ts-self-types="./newel_engine.d.ts" */

export class Newel {
    static __wrap(ptr) {
        const obj = Object.create(Newel.prototype);
        obj.__wbg_ptr = ptr;
        NewelFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        NewelFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_newel_free(ptr, 0);
    }
    /**
     ...
     */
    cell_kind(r, c) {
        const ret = wasm.newel_cell_kind(this.__wbg_ptr, r, c);
        return ret >>> 0;
    }
    /**
     ...
     */
    cell_letter(r, c) {
        const ret = wasm.newel_cell_letter(this.__wbg_ptr, r, c);
        return ret >>> 0;
    }
    /**
     ...
     */
    cell_was_clue(r, c) {
        const ret = wasm.newel_cell_was_clue(this.__wbg_ptr, r, c);
        return ret !== 0;
    }
    /**
     * @returns {number}
     */
    cols() {
        const ret = wasm.newel_cols(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    current_letter() {
        const ret = wasm.newel_current_letter(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    static from_data(rows, cols, solution_flat, clues_flat, serve_order) {
        ...
        const ret = wasm.newel_from_data(rows, cols, ptr0, len0, ptr1, len1, ptr2, len2);
        return ret === 0 ? undefined : Newel.__wrap(ret);
    }
    /**
    ...
    static from_seed(seed) {
        const ret = wasm.newel_from_seed(seed);
        return ret === 0 ? undefined : Newel.__wrap(ret);
    }
    /**
     * 5x5 grid with exactly 2 opposite-corner cells blocked.
    ...
    static from_seed_5x5(seed) {
        const ret = wasm.newel_from_seed_5x5(seed);
        return ret === 0 ? undefined : Newel.__wrap(ret);
    }
    /**
     * @returns {boolean}
     */
    is_lost() {
        const ret = wasm.newel_is_lost(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    is_tappable(r, c) {
        const ret = wasm.newel_is_tappable(this.__wbg_ptr, r, c);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    is_won() {
        const ret = wasm.newel_is_won(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {number}
     */
    max_mistakes() {
        const ret = wasm.newel_max_mistakes(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    mistakes() {
        const ret = wasm.newel_mistakes(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    rows() {
        const ret = wasm.newel_rows(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    serve_cell(step) {
        const ret = wasm.newel_serve_cell(this.__wbg_ptr, step);
        return ret >>> 0;
    }
    /**
     ...
     */
    serve_letter(step) {
        const ret = wasm.newel_serve_letter(this.__wbg_ptr, step);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    served_count() {
        const ret = wasm.newel_served_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    solution_letter(r, c) {
        const ret = wasm.newel_solution_letter(this.__wbg_ptr, r, c);
        return ret >>> 0;
    }
    /**
     ...
     */
    tap(r, c) {
        const ret = wasm.newel_tap(this.__wbg_ptr, r, c);
        return ret >>> 0;
    }
    /**
     ...
     */
    total_to_serve() {
        const ret = wasm.newel_total_to_serve(this.__wbg_ptr);
        return ret >>> 0;
    }
}
if (Symbol.dispose) Newel.prototype[Symbol.dispose] = Newel.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./newel_engine_bg.js": import0,
    };
}

const NewelFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_newel_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('newel_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
