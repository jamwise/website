...
export class CrosswordGame {
     ...
     */
    static from_data(rows: number, cols: number, solution_flat: Uint8Array, clues_flat: Uint8Array, serve_order: Uint32Array): CrosswordGame | undefined;
    /**
     * Create a new game from a seed using a fully-open 4x4 grid (no blocks).
     */
    static from_seed(seed: bigint): CrosswordGame | undefined;
    /**
     * 4x4 fully-open grid, no blocks. 16 cells, 4 across + 4 down length-4.
     */
    static from_seed_4x4(seed: bigint): CrosswordGame | undefined;
    /**
     * 5x5 grid with exactly 2 opposite-corner cells blocked.
     */
    static from_seed_5x5(seed: bigint): CrosswordGame | undefined;
    /**
     * 6x6 grid with 0–4 corner cells blocked.
     */
    static from_seed_6x6(seed: bigint): CrosswordGame | undefined;
    is_lost(): boolean;
    /**
...
export interface InitOutput {
    ...
    readonly __wbg_crosswordgame_free: (a: number, b: number) => void;
    readonly crosswordgame_cell_kind: (a: number, b: number, c: number) => number;
    readonly crosswordgame_cell_letter: (a: number, b: number, c: number) => number;
    readonly crosswordgame_cell_was_clue: (a: number, b: number, c: number) => number;
    readonly crosswordgame_cols: (a: number) => number;
    readonly crosswordgame_current_letter: (a: number) => number;
    readonly crosswordgame_from_data: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
    readonly crosswordgame_from_seed: (a: bigint) => number;
    readonly crosswordgame_from_seed_4x4: (a: bigint) => number;
    readonly crosswordgame_from_seed_5x5: (a: bigint) => number;
    readonly crosswordgame_from_seed_6x6: (a: bigint) => number;
    readonly crosswordgame_is_lost: (a: number) => number;
    readonly crosswordgame_is_tappable: (a: number, b: number, c: number) => number;
    readonly crosswordgame_is_won: (a: number) => number;
    readonly crosswordgame_max_mistakes: (a: number) => number;
    readonly crosswordgame_mistakes: (a: number) => number;
    readonly crosswordgame_rows: (a: number) => number;
    readonly crosswordgame_serve_cell: (a: number, b: number) => number;
    readonly crosswordgame_serve_letter: (a: number, b: number) => number;
    readonly crosswordgame_served_count: (a: number) => number;
    readonly crosswordgame_solution_letter: (a: number, b: number, c: number) => number;
    readonly crosswordgame_tap: (a: number, b: number, c: number) => number;
    readonly crosswordgame_total_to_serve: (a: number) => number;
